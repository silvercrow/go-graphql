...
func (ec *executionContext) field_Mutation_createDog_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalONewDog2ᚖgithubᚗcomᚋsilvercrowᚋgoᚑgraphqlᚋgraphᚋmodelᚐNewDog(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) field_Query_dog_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["_id"]; ok {
		ctx := graphql.WithFieldInputContext(ctx, graphql.NewFieldInputWithField("_id"))
		arg0, err = ec.unmarshalNString2string(ctx, tmp)
		if err != nil {
			return nil, err
		}
...
func (ec *executionContext) _Mutation_createDog(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNDog2ᚖgithubᚗcomᚋsilvercrowᚋgoᚑgraphqlᚋgraphᚋmodelᚐDog(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_dogs(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Dog)
	fc.Result = res
	return ec.marshalNDog2ᚕᚖgithubᚗcomᚋsilvercrowᚋgoᚑgraphqlᚋgraphᚋmodelᚐDogᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputNewDog(ctx context.Context, obj interface{}) (model.NewDog, error) {
	...
	for k, v := range asMap {
		...
		case "isGoodBoy":
			...
			ctx := graphql.WithFieldInputContext(ctx, graphql.NewFieldInputWithField("isGoodBoy"))
...
func (ec *executionContext) marshalNDog2githubᚗcomᚋsilvercrowᚋgoᚑgraphqlᚋgraphᚋmodelᚐDog(ctx context.Context, sel ast.SelectionSet, v model.Dog) graphql.Marshaler {
	return ec._Dog(ctx, sel, &v)
}

func (ec *executionContext) marshalNDog2ᚕᚖgithubᚗcomᚋsilvercrowᚋgoᚑgraphqlᚋgraphᚋmodelᚐDogᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Dog) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNDog2ᚖgithubᚗcomᚋsilvercrowᚋgoᚑgraphqlᚋgraphᚋmodelᚐDog(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNDog2ᚖgithubᚗcomᚋsilvercrowᚋgoᚑgraphqlᚋgraphᚋmodelᚐDog(ctx context.Context, sel ast.SelectionSet, v *model.Dog) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) unmarshalONewDog2ᚖgithubᚗcomᚋsilvercrowᚋgoᚑgraphqlᚋgraphᚋmodelᚐNewDog(ctx context.Context, v interface{}) (*model.NewDog, error) {
	if v == nil {
		return nil, nil
	}
